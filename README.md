# Sistema de Gestión de Piscicultura "Lagos Andinos" SRL
...
Sistema de información desarrollado en **Blazor Hybrid** con **SQL Server 2022** para la gestión integral del proceso de piscicultura, desde la siembra de alevines hasta la cosecha y entrega al departamento de ventas.

La aplicación Blazor Hybrid permitirá a los técnicos capturar datos en tiempo real desde dispositivos móviles en los estanques, sincronizándolos con una base de datos centralizada en SQL Server. Esto garantiza que la información sobre alimentación, calidad del agua y crecimiento de los lotes esté disponible para la toma de decisiones estratégicas de manera inmediata.
...
- **Metodología de Desarrollo**: XP (eXtreme Programming) + SCRUM
- **Técnicas de Estimación**: Planning Poker
- **Metáfora del Sistema**: "Bitácora de Ciclo Vital" - Los lotes de peces fluyen a través de estaciones (estanques) donde se monitorea su salud y alimentación hasta alcanzar la madurez comercial.
...
- **Gestión del Proceso de Crianza Acuícola** (4 fases)
- **Control de Parámetros del Agua y Tratamientos**
- **Gestión de Inventario de Peces**
